...
public class DaoRequest {
	private static RequestCode request;
	 ...
	 * @param url
	 */
	public DaoRequest(RequestCode code, String url) {
		request = code;
		this.shortUrl=url;
	 ...
	 * @param code
	 */
	public void setRequestCode(RequestCode code) {
	 ...
	 * @param code
	 */
	private void setShortUrlForScope(RequestCode code) {
		switch(code) {
